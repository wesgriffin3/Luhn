...
RSpec.describe Luhn, type: :model do
  describe 'is_valid? it should work' do
    ...
    it 'should return false if number is invalid and has an even number of digits' do
